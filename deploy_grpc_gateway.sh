...
echo "Download github.com/stabilaprotocol/grpc-gateway successfully"
...
nohup go run stabila_http/main.go -port $port -host $host -listen $listen >> start_grpc_gateway.log 2>&1 &
